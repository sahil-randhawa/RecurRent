					...
					<FlatList
						...
						renderItem={(rowData) => {
                            ...
                            <View style={{flexDirection:"row", paddingBottom:10}}>
                                <View>
                                    <Image source={ {uri: rowData.item["productPhoto"]} } style={styles.productImg}  resizeMode={"stretch"} />
                                </View>
                                <View style={{paddingLeft:20}}>
                                    ...
                                    <Text><Text style={typography.bodyHeading}>Renter Email:</Text> {rowData.item.renterEmail}</Text>
                                    <Text><Text style={typography.bodyHeading}>Renter Mobile Number:</Text> {rowData.item.renterMobileNumber}</Text>
